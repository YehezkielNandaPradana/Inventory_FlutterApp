        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Stok masuk $jumlah unit untuk ${_selectedBarang!.nama}',
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 12),
            Text('Stok Masuk', style: AppTextStyles.h1.copyWith(fontSize: 20)),
          ],
        ),
      ),
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Catat pemasukan barang ke inventori',
        ...
        child: Column(
          ...
          children: [
            ...
            _buildField(
              ...
              hint: 'Contoh: Pembelian dari supplier',
